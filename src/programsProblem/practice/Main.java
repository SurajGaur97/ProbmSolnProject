...
//        System.out.println(subsetSum.subSetSum(new int[]{10,10,30,10,40}, 70, 5));
		...
		/*int[] arr = new int[]{64, 25, 12, 22, 11};
		bubbleSort.sortIt(arr);
//		selectionSort.sortIt(arr);
		for(int num: arr) {
			System.out.print(num + " ");
		}*/
...
//		arrowPrinting.printArrow(9);

//		butterflyPattern.printButterflyPattern(5);

//		floydsTrianglePattern.printFloydsTriangle(7);

//		halfNumDiamond.solidOddHalfDiamond(4);
//		halfNumDiamond.solidHalfStarNumIncDiamond(5);
//		halfNumDiamond.solidHalfStarNumDiamond(4);
//		halfNumDiamond.solidHalfNumDiamond(4);

//		diamondPattern.diamondDiagonalNSide1(7);	//Put odd nos
//		diamondPattern.hollowedDiamInRect(6);
//		diamondPattern.solidHalfDiamond(5);
//		diamondPattern.hollowDiamond(5);
//		diamondPattern.solidDiamond(5);

//		pyrPatAlphaNum.fullPyramidStarNum(5);
//		pyrPatAlphaNum.fullPyramid(5);
//		pyrPatAlphaNum.halfPyramidOddAlpha(26);
//		pyrPatAlphaNum.halfPyramidOddNum(5);

//		pyramidPatternsNo.hollowedFullPyramid(6);
//		pyramidPatternsNo.fullPyramid(5);
//		pyramidPatternsNo.hollowedInvertedHalfPyramid(5);
//		pyramidPatternsNo.hollowedHalfPyramid(5);
//		pyramidPatternsNo.invertedHalfPyramid(5);
//		pyramidPatternsNo.halfPyramid(5);

//		pyramidPatterns.hollowedFullyPyramid(6);
//		pyramidPatterns.invertedFullyPyramid(6);
//		pyramidPatterns.fullyPyramid(6);
//		pyramidPatterns.hollowedInvertedHalfPyramid(9);
//		pyramidPatterns.invertedHalfPyramid(4);
//		pyramidPatterns.halfPyramid(4);

//		rectanglePatterns.diagonalAndSides(7);
//		rectanglePatterns.hollowRectangle(4, 7);
//		rectanglePatterns.solidRectangle(3, 5);

		/*Map<String, Integer> hm = new LinkedHashMap<>();
		hm.put("Ankit", 160);
		hm.put("Suraj", 80);
		moneyCalculation.calculateMoney(hm);*/
...
//		System.out.println(reverseNumber.getReverseNum(123));

//		System.out.println(nonRepeatingVowel.getVowel("Hiello World!"));

//		System.out.println(highestNo.getSecondMax(new int[] {1,2,3,4,5,5}));
		...
		/*Teting teting = (a, b) -> System.out.println(a + b);	//Lambda expression with functional Interface
		teting.sum(10,90);*/

//		System.out.println(correspondingFragmentsCodility.solution5("dBacaAA", "caBdaaA"));

//		System.out.println(correspondingFragmentsCodility.solution3(new int[]{30,20,10}));

//		System.out.println(correspondingFragmentsCodility.solution("dBacaAA", "caBdaaA"));

//		System.out.println(correspondingFragmentsCodility.solution1("BAAABAB"));

//		System.out.println(characterReplacement.characterReplacement("ABAB", 2));

//		System.out.println(repeatingCharacters.lengthOfLongestSubstring1(" "));

//		maximum69No.solution(1234);

//		System.out.println(smallestPositiveNo.solution(new int[] {1, 3, 6, 4, 1, 2}));

//		System.out.println(printCountsOfNumbers.returnCount(new ArrayList<Integer>(List.of(1,1,1,3,3,2,2,4))));

//		 System.out.println(maximumcharInString.solution("Codility"));


		/*LinkedListManupulation listUtil = new LinkedListManupulation();

		MyLinkedList linkedList = new MyLinkedList(1); MyLinkedList linkedList1 = new MyLinkedList(2); MyLinkedList linkedList2 = new MyLinkedList(3); MyLinkedList linkedList3 = new MyLinkedList(4); linkedList.setLink(linkedList1);
		linkedList1.setLink(linkedList2); linkedList2.setLink(linkedList3);
		linkedList3.setLink(null);

		System.out.println("Getting size of list");
		System.out.println(listUtil.getLength(linkedList));

		System.out.println("Printing all element of list");
		listUtil.getAll(linkedList);

		System.out.println("Printing first element"); listUtil.getFirst(linkedList);

		System.out.println("Printing Last element"); listUtil.getLast(linkedList);

		System.out.println("priting element at index");
		listUtil.getAtIndex(linkedList, 1);

		//----------------------------------------------------//

		checkPrimeNum.checkPrimeNum(9);

		reverseString.getReverse("suraj");

		swapNumber.getSwapedNumber(10, 23);*/


		/*int[] ans = countingBits.countBits(9);
		for(int i = 0; i < ans.length; i++) {
			System.out.println(ans[i]);
		}*/

//		 System.out.println(missingNumber.missingNumber1(new int[] { 0, 1 }));

		/*System.out.println(reverseBit.reverseBits1(13));
