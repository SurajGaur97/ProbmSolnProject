...
public class MissingNumber {
	 ...
	 * Input: nums = [0,1] 
	 * Output: 2 
	 * Explanation: n = 2 since there are 2
...
//		for (int i = 0, sumIndx = 1; i < nums.length; i++, sumIndx++) {
//			missingNum = missingNum + sumIndx - nums[i];
//		}
	...
	//Bit Manupultaion
	public Integer missingNumber1(int[] nums) {
